function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://129.151.102.111:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        url:"http://129.151.102.111:8080/api/Category/save",
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://129.151.102.111:8080/api/Category/update",
        type:"PUT",
        data:dataToSend,
...
function borrarCategoria(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.102.111:8080/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function autoInicioMotos(){
    ...
    $.ajax({
        url:"http://129.151.102.111:8080/api/Motorbike/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionMotos(){
    let var2 = {
        ...
        dataType: 'JSON',
        data: JSON.stringify(var2),
        url:"http://129.151.102.111:8080/api/Motorbike/save",
...
function actualizarInformacionOrtesis(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.102.111:8080/api/Motorbike/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarOrtesis(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.102.111:8080/api/Motorbike/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function autoInicioCliente(){
    ...
    $.ajax({
        url:"http://129.151.102.111:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionCliente(){
    let var2 = {
        ...
        console.log(var2);
        $.ajax({
        url:"http://129.151.102.111:8080/api/Client/save",
        type:'POST',
        contentType: "application/json; charset=utf-8",
        dataType: 'JSON',
        data: JSON.stringify(var2),
...
function actualizarInformacionCliente(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.102.111:8080/api/Client/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarCliente(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.102.111:8080/api/Client/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function autoInicioMensajes(){
    ...
    $.ajax({
        url:"http://129.151.102.111:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionMensaje(){
    let var2 = {
        ...
        console.log(var2);
        $.ajax({
        url:"http://129.151.102.111:8080/api/Message/save",
        type:'POST',
        contentType: "application/json; charset=utf-8",
        dataType: 'JSON',
        data: JSON.stringify(var2),
...
function actualizarInformacionMensajes(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.102.111:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarMensaje(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.102.111:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function autoInicioReservacion(){
    console.log("Mensajes con normalidad")
    $.ajax({
        url:"http://129.151.102.111:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionReservacion(){
    let var2 = {
        ...
        console.log(var2);
        $.ajax({
        url:"http://129.151.102.111:8080/api/Reservation/save",
        type:'POST',
        contentType: "application/json; charset=utf-8",
        dataType: 'JSON',
        data: JSON.stringify(var2),
...
function actualizarInformacionReservacion(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.102.111:8080/api/Reservation/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarReservacion(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.102.111:8080/api/Reservation/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
